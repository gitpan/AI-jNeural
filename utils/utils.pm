...
AI::jNeural::utils - The utils directory module

=head1 SYNOPSIS

  use AI::jNeural::utils;

=head1 DESCRIPTION

This particular module doesn't actually do anything.  It would be the place to
look for functions that are general to the utils directory, but there
really arn't any yet.
